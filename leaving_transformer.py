...
input_caviar_leaving1_file_path = "Leaving/LeftBag/lb1gt.xml"
input_caviar_leaving2_file_path = "Leaving/LeftBag_AtChair/lb2gt.xml"
input_caviar_leaving3_file_path = "Leaving/LeftBag_BehindChair/lbbcgt.xml"
input_caviar_leaving4_file_path = "Leaving/LeftBag_PickedUp/lbpugt.xml"
input_caviar_leaving5_file_path = "Leaving/LeftBox/lbgt.xml"
output_dir = "/home/samx/Documents/PROJECTS/caviar-annotation-to-yolo-annotation/output"

file_list = []
file_list.append(input_caviar_leaving1_file_path)
# file_list.append(input_caviar_leaving2_file_path)
# file_list.append(input_caviar_leaving3_file_path)
# file_list.append(input_caviar_leaving4_file_path)
# file_list.append(input_caviar_leaving5_file_path)
